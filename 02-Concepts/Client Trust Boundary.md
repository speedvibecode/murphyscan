...
source_reels: [reel-11, reel-15, reel-55, reel-105]
---
...
- [[reel-105]] - backend routes must validate and sanitize every important request.
...
- Does the backend reject malformed or unexpected payloads instead of trusting UI shape?
